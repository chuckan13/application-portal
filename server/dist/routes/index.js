...
var _responses = _interopRequireDefault(require("../controllers/responses"));
...
function _default(app) {
  ...
  app.get('/api/users/:id', _cas["default"].block, _users["default"].retrieve);
  ...
  app.post('/api/responses', _cas["default"].block, _responses["default"].create);
  app.get('/api/responses', _cas["default"].block, _responses["default"].list);
}